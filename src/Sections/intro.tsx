...
const Intro: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-[1200px] flex-col items-center justify-center gap-4 p-6 md:flex-row md:gap-0 lg:gap-8">
        {/* Profile Image */}
        ...
        {/* Text Content */}
        <div className="flex flex-col items-center justify-center text-center md:-ml-4 md:items-start md:text-left lg:-ml-10">
